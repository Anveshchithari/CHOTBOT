...
function report_issue(agent)
{
  ...
  5:"reloading",6:"slow loading",7:"Buffering problem",8:"site not reach"};
  ...
  if(intent_val>8){
    agent.add("Please enter a valid issue");
  }
  else{
  ...
  "richContent": [
      ...
      },
    {
      ...
      },
      {
        "type": "list",
        "title": "Reloading",
        "subtitle": "Press '5' for reloading",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
      ...
      },
	  {
        "type": "list",
        "title": "Buffering problem",
        "subtitle": "Press '7' for Buffering problem",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
    ...
    {
        "type": "list",
        "title": "site cant reach",
        "subtitle": "Press '8' for site cant reach",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
